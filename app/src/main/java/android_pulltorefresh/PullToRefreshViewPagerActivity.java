...
import dubo.pulltorefreshlist.R;
...
public class PullToRefreshViewPagerActivity extends Activity implements OnRefreshListener<ViewPager> {
	...
	static class SamplePagerAdapter extends PagerAdapter {
		...
		private static int[] sDrawables = { R.drawable.splash_image_view, R.drawable.splash_image_view, R.drawable.splash_image_view,
				R.drawable.splash_image_view, R.drawable.splash_image_view, R.drawable.splash_image_view};
